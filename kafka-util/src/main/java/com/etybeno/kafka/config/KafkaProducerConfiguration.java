package com.etybeno.kafka.config;

import com.etybeno.kafka.service.KafkaLogHandler;
...
import org.iff.common.config.BaseConfiguration;
import org.iff.common.service.ShutdownHookCleanup;
import org.iff.common.service.model.ExecutorCleanupUnit;
...
public class KafkaProducerConfiguration {
    ...
    public KafkaProducerConfiguration() throws ConfigurationException {
        ...
        shutdownHook.addExecutor(new ExecutorCleanupUnit(KafkaLogHandler.class.getName(), executor));
    }
